...
public class QuestionTaskTest extends TestBase {

    private final String expectedText;
    private final int questionNumber;

    public QuestionTaskTest(String expectedText, int questionNumber) {
    ...
    public void checkText() {
        QuestionTask questionTask = new QuestionTask(driver);
        String result = questionTask.findElements(questionNumber);
